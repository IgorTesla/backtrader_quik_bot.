...
def OnTrade(data):
      ...
      """
      print('OnTrade')
      print(datetime.now(), data['data'])  # Печатаем полученные данные
      #mainCallBackFunc()
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    secCode = 'RIM3'  # Код тикера
    TransId = 12345  # Номер транзакции
    price = 133230  # Цена входа/выхода
    ...
    # Новая стоп заявка
    StopSteps = 100  # Размер проскальзывания в шагах цены
    ...
    transaction = {  # Все значения должны передаваться в виде строк
        ...
        'EXPIRY_DATE': 'TODAY'}  # Срок действия до отмены
